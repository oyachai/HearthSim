...
public class TestDragonlingMechanic {
	...
	public void setup() throws HSException {
		...
		DragonlingMechanic fb = new DragonlingMechanic();
	...
	public void test2() throws HSInvalidPlayerIndexException {
		...
		assertEquals(board.data_.getMinion_p0(3).getHealth(), health1 - 1);
		assertEquals(board.data_.getMinion_p1(0).getHealth(), health0);
		assertEquals(board.data_.getMinion_p1(1).getHealth(), health1 - 1);
		...
		assertEquals(board.data_.getMinion_p0(3).getAttack(), attack0);
	}
}
