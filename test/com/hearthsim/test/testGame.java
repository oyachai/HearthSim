...
public class testGame {
	...
	public void testGame() {
		...
		for (int i = 0; i < numCardsInDeck_; ++i) {
			...
			cards1_[i] = new Minion("" + i, mana, attack, health, attack, health, health, false, false, false, false, false, false, true, false);
			cards2_[i] = new Minion("" + i, mana, attack, health, attack, health, health, false, false, false, false, false, false, true, false);
		}
