...
public class TestHolySmite {
	...
	public void test0() {
		...
		assertTrue("test0_4", board.getHero_p0().getHealth() == 28);
	...
	public void test1() {
		...
		assertTrue("test1_3", board.getHero_p1().getHealth() == 28);
	...
	public void test3() {
		...
		assertTrue("test3_7", board.getMinion_p0(1).getHealth() == health1 - 2);
	...
	public void test5() {
		...
		assertTrue("test5_9", board.getMinion_p1(1).getHealth() == health1 - 2);
	}
}
