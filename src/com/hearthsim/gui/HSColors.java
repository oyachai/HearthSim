...
public class HSColors {
	...
	//card rarity colors
	public static final Color CARD_FREE_COLOR = new Color(255, 255, 255);
	public static final Color CARD_COMMON_COLOR = new Color(15, 230, 3);
	public static final Color CARD_RARE_COLOR = new Color(45, 172, 255);
	public static final Color CARD_EPIC_COLOR = new Color(212, 124, 255);
	public static final Color CARD_LEGENDARY_COLOR = new Color(255, 162, 0);
