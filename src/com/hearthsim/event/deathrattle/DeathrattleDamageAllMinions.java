		...
		throws HSException
	{
		...
		if (toRet != null) {
			for(Minion aMinion : toRet.data_.getMinions_p1()) {
				toRet = aMinion.takeDamage(damage_, thisPlayerIndex, 1, toRet, deckPlayer0, deckPlayer1);
			}
			for(Minion aMinion : toRet.data_.getMinions_p0()) {
				toRet = aMinion.takeDamage(damage_, thisPlayerIndex, 0, toRet, deckPlayer0, deckPlayer1);
			}
		}
		return toRet;
	}
