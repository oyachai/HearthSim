...
public class HearthSim {
	...
	public int runSingleGame() throws HSException {
		...
		for (int i = 0; i < numCardsInDeck_; ++i) {
			...
			cards1_[i] = new Minion("" + i, mana0, attack0, health0, attack0, health0, health0, false, false, false, false, false, true, false);
			...
			cards2_[i] = new Minion("" + i, mana1, attack1, health1, attack1, health1, health1, false, false, false, false, false, true, false);
		}
