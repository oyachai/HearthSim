...
public class FlameImp extends Demon {
	
	private static final String NAME = "Flame Imp";
		...
		throws HSException
	{
		...
		if (toRet != null) {
			toRet = side.getPlayer(toRet).getHero().takeDamage((byte)3, side, side, toRet, deckPlayer0, deckPlayer1, false, false);
		}
		return toRet;
	}
}
