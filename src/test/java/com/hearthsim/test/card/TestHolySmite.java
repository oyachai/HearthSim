...
public class TestHolySmite {
	...
	public void test3() throws HSException {
		...
		assertTrue("test3_7", PlayerSide.CURRENT_PLAYER.getPlayer(board).getMinions().get(1).getHealth() == health1 - 2);
	...
	public void test5() throws HSException {
		...
		assertTrue("test5_9", PlayerSide.WAITING_PLAYER.getPlayer(board).getMinions().get(1).getHealth() == health1 - 2);
	}
}
