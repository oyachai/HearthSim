...
public class TestArathiWeaponsmith {
	...
	public void test0() throws HSException {
		...
		assertEquals(board.data_.getMinion_p0(0).getTotalHealth(), 3);
		assertEquals(board.data_.getMinion_p0(1).getTotalHealth(), 6);
	...
	public void test1() throws HSException {
		...
		assertEquals(board.data_.getMinion_p0(0).getTotalHealth(), 3);
		assertEquals(board.data_.getMinion_p0(1).getTotalHealth(), 6);
		assertEquals(board.data_.getMinion_p0(2).getTotalHealth(), 4);
		assertEquals(board.data_.getMinion_p1(0).getTotalHealth(), 2);
		assertEquals(board.data_.getMinion_p1(1).getTotalHealth(), 2);
