...
public class TestAlexstrasza {
	...
	public void test1() throws HSException {
		...
		assertEquals(c0.data_.getCurrentPlayerHero().getHealth(), 30);
		assertEquals(c0.data_.getWaitingPlayerHero().getHealth(), 15);
		...
		assertEquals(c1.data_.getCurrentPlayerHero().getHealth(), 15);
		assertEquals(c1.data_.getWaitingPlayerHero().getHealth(), 30);
