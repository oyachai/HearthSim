...
public class TestGrimscaleOracle {
	...
	public void test2() throws HSException {
		...
		assertEquals(PlayerSide.CURRENT_PLAYER.getMinions().get(2).getHealth(), health1 - 1);
		assertEquals(PlayerSide.WAITING_PLAYER.getMinions().get(0).getHealth(), health0);
		assertEquals(PlayerSide.WAITING_PLAYER.getMinions().get(1).getHealth(), health1 - 1);
		...
		assertEquals(PlayerSide.CURRENT_PLAYER.getMinions().get(2).getTotalAttack(), attack0);
	...
	public void test3() throws HSException {
		...
		assertEquals(PlayerSide.CURRENT_PLAYER.getMinions().get(1).getTotalAttack(), 1);
		assertEquals(PlayerSide.CURRENT_PLAYER.getMinions().get(2).getTotalAttack(), attack0);
		assertEquals(PlayerSide.CURRENT_PLAYER.getMinions().get(3).getTotalAttack(), 3);
		assertEquals(PlayerSide.WAITING_PLAYER.getMinions().get(0).getTotalAttack(), attack0);
		assertEquals(PlayerSide.WAITING_PLAYER.getMinions().get(1).getTotalAttack(), attack0);
	}
}
