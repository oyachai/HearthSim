...
public class TestDreadInfernal {
	...
	public void test2() throws HSException {
		...
		assertEquals(PlayerSide.CURRENT_PLAYER.getMinions().get(0).getHealth(), health0 - 1);
		assertEquals(PlayerSide.CURRENT_PLAYER.getMinions().get(1).getHealth(), 6);
		assertEquals(PlayerSide.CURRENT_PLAYER.getMinions().get(2).getHealth(), health1 - 1 - 1);
		assertEquals(PlayerSide.WAITING_PLAYER.getMinions().get(0).getHealth(), health0 - 1);
		assertEquals(PlayerSide.WAITING_PLAYER.getMinions().get(1).getHealth(), health1 - 1 - 1);
