...
import com.hearthsim.card.classic.spell.common.CircleOfHealing;
...
public class TestCircleOfHealing {
    ...
    private static final byte health1 = 8;
    ...
    public void setup() throws HSException {
        ...
        Minion minion0_1 = new MinionMock("" + 0, mana, attack0, (byte)(health1 - 4), attack0, health1, health1);
        Minion minion1_0 = new MinionMock("" + 0, mana, attack0, health0, attack0, health0, health0);
        Minion minion1_1 = new MinionMock("" + 0, mana, attack0, (byte)(health1 - 4), attack0, health1, health1);
