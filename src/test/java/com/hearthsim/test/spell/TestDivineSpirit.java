...
public class TestDivineSpirit {
    ...
    public void test2() throws HSException {
        ...
        assertEquals(currentPlayer.getCharacter(CharacterIndex.MINION_1).getHealth(), health0 * 2);
        ...
        assertEquals(currentPlayer.getCharacter(CharacterIndex.MINION_1).getMaxHealth(), health0 * 2);
    ...
    public void test3() throws HSException {
        ...
        assertEquals(currentPlayer.getCharacter(CharacterIndex.MINION_2).getHealth(), health1 - 1);
        assertEquals(waitingPlayer.getCharacter(CharacterIndex.MINION_1).getHealth(), health0);
        assertEquals(waitingPlayer.getCharacter(CharacterIndex.MINION_2).getHealth(), (health1 - 1) * 2);

        assertEquals(waitingPlayer.getCharacter(CharacterIndex.MINION_2).getMaxHealth(), health1 + health1 - 1);
