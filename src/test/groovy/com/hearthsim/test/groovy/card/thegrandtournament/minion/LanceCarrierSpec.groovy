...
import com.hearthsim.card.thegrandtournament.minion.common.LanceCarrier
...
class LanceCarrierSpec extends CardSpec {
    ...
    def "gives a friendly minion +2 attack"() {
        def copiedBoard = startingBoard.deepCopy()
        def theCard = new LanceCarrier()
